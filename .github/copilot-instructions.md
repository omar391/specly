...
- Update `./.task/todo/current.md`. Do NOT move completed tasks out of `current.md` automatically; only move to `./.task/todo/done_<today-date>.md` when the user explicitly requests it.
