...
describe('ExpressServer – SSE, sessions, and static UI', () => {
    ...
    describe('Production static UI fallback', () => {
        const uiDistPath = path.resolve(process.cwd(), 'src/ui/dist');
        ...
        it('serves index.html for non-API GET requests when dist exists', async () => {
            ...
            // The real repo UI/dist may exist; assert generic SPA marker from template
            expect(res.text.toLowerCase()).toContain('<div id="root"></div>');
